...
<Card title="API Key + Secret" icon="key">
  Connect using your Amplitude API key and secret key. Obtain these from your Amplitude project settings under **Settings > Projects > [Your Project]**.

  - **API Key**: Your project's API key
  - **Secret Key**: Your project's secret key

  See the [Amplitude authentication docs](https://amplitude.com/docs/apis/authentication) for details.
</Card>
